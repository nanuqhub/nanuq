MODULE in_out_manager
   ...
   TYPE :: sn_ctl                !: structure for control over output selection
      ...
      LOGICAL :: l_oasout  = .FALSE.  !: Produce/do not write oasis setup info to nanuq.output (T/F)
      ...
      INTEGER :: ptimincr  = 1        !: timestep increment to output (nanuq.step and nanuq.stat)
   END TYPE sn_ctl
