## PLaying with the CHANNELD17 test-case
...
Copy or create symbolic links of all the netCDF files found under `<SOMEWHERE>/INPUT_NANUQ_DISTRIB/CHANNELD17/<RES>km` in here.
